...
def win_map_net_drive():
    ...
    command = "net use " + server_config.get("global",
                                             "mappingLetter") + ": \\\\" + server_config.get("global",
                                                                                             "serverIp") + server_config.get(
        "global",
        "pathName").replace("/", "\\") + "/USER:" + server_config.get("user", "userLogin") + " " + server_config.get(
