...
from common.utils.utils import write_file, read_file, get_files_dir
...
def create_instruction(content):
    ...
    hostname = socket.gethostname()
    file_path = server_config.get("global", "mappingLetter") + ":/" + hostname + "/instructions/" + instruction_name_file()
